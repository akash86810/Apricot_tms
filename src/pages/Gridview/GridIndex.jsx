  ...
  const allTickets = [
    {
      ...
      description: 'The system either hangs or returns an error message saying "Data fetch timeout." I have tried reloading the page and clearing the cache,',
      fullDescription: 'The system either hangs or returns an error message saying "Data fetch timeout." I have tried reloading the page and clearing the cache, but the issue persists. This is affecting our monthly reporting process.',
      tag: 'MT940',
      status: 'Created',
      timestamp: null
    },
