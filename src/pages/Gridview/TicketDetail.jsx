...
const TicketDetail = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row h-screen">
        ...
        <div className="flex-1 overflow-auto px-8">
          <PageHeader className="bg-[#fafafa]"/>
          {/* Ticket number line */}
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-[#42A0EE] font-medium">Assign team member</span>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700 text-sm underline" style={{ color: '#42A0EE' }}>
                img001.png
              </span>
            </div>
          ...
          <div className="relative flex items-center ml-10 mt-40 border border-gray-400 rounded-full overflow-hidden">
            <input
              type="text"
    ...
    // <div>
    //   <h1>{ticket.title}</h1>
    //   <p>{ticket.fullDescription}</p>
    //   <p>Status: {ticket.status}</p>
    //   <p>Tag: {ticket.tag}</p>
    //   <p>Timestamp: {ticket.timestamp || 'N/A'}</p>
    // </div>
  );
};
